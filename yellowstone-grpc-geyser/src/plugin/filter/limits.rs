...
pub struct FilterLimitsAccounts {
    ...
    pub account_reject: FxHashSet<Pubkey>,
    pub owner_max: usize,
    #[serde(deserialize_with = "deserialize_pubkey_set")]
    pub owner_reject: FxHashSet<Pubkey>,
...
impl Default for FilterLimitsAccounts {
    fn default() -> Self {
        Self {
            ...
            account_reject: FxHashSet::default(),
            owner_max: usize::MAX,
            owner_reject: FxHashSet::default(),
...
pub struct FilterLimitsTransactions {
    ...
    #[serde(deserialize_with = "deserialize_pubkey_set")]
    pub account_include_reject: FxHashSet<Pubkey>,
    #[serde(deserialize_with = "deserialize_usize_str")]
...
impl Default for FilterLimitsTransactions {
    fn default() -> Self {
        Self {
            ...
            account_include_reject: FxHashSet::default(),
...
fn deserialize_pubkey_set<'de, D>(deserializer: D) -> Result<FxHashSet<Pubkey>, D::Error>
where
    D: Deserializer<'de>,
{
