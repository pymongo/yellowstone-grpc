...
pub const DEFAULT_RATE_LIMIT_MAX_HITS_FALLBACK: i32 = 1000;
...
pub struct MethodRatelimiter {
    ...
    window: Duration,
    max_hits_fallback: i32,
    idle_timeout: Duration,
    gc_tick: usize,
}

impl MethodRatelimiter {
    pub fn new(max_hits_fallback: i32, window: Duration) -> Self {
        Self::with_gc(
            max_hits_fallback,
            window,
    ...
    fn inner_call(
        ...
        let window_key = MethodRatelimitKey {
            ...
            ratelimit: subscription_info
                ...
                .copied()
                .unwrap_or(self.max_hits_fallback),
        };
